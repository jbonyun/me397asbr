...
test_cases = {};
test_cases{end + 1} = {deg2rad(joints(3,:))', [-4.87125941617731 -0.0735561342818407 0.63521184011302 4.18870325095684 1.91282383432598 3.3090539278487 -2.35266570423377]'};
...
for i_test_cases = 1:numel(test_cases)
    ...
    % Now solve it.
    ik_angles = DLS_inverse_kinematics(robot, init_guess, target_pose);
